    ...
    <div class="panel panel-default" data-collapsed="0"
      style="border-color: #dedede;">
        ...
        <?php if ($valid == true) { ?>
          <p>
            <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
              <a href="<?php echo site_url('install/step3');?>" class="btn m-btn--pill    btn-primary m-btn m-btn--custom">
                Continue
              </a>
            <?php } else { ?>
              <a href="<?php echo site_url('install/step2');?>" class="btn m-btn--pill    btn-primary m-btn m-btn--custom">
                Continue
              </a>
            <?php } ?>
          </p>
        ...
        <?php if ($valid != true) { ?>
          <p>
            <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
              <a href="<?php echo site_url('install/step3');?>" class="btn m-btn--pill    btn-primary m-btn m-btn--custom" disabled>
                Continue
              </a>
            <?php } else { ?>
              <a href="<?php echo site_url('install/step2');?>" class="btn m-btn--pill    btn-primary m-btn m-btn--custom" disabled>
                Continue
              </a>
            <?php } ?>
            <a href="<?php echo site_url('install/step1');?>" class="btn m-btn--pill    btn-primary m-btn m-btn--custom" >
