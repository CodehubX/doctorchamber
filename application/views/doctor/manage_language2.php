...
<button onClick="copy_language()">copy</button>
						...
						echo form_open(site_url('doctor/manage_language/update_phrase/'.$current_editing_language)  , array('id' => 'phrase_form'));
						$count = 1;
          ...
          <div id="copy_from_<?php echo $row['phrase_id'];?>"><?php echo ucwords(str_replace( '_' ,' ',$row['phrase']));?></div>
			...
			function copy_language()
			{
				...
				copy_text	= copy_text.replace('<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">' ,'');
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-normal">
                    ...
                    <tbody>
                    	...
                    	<tr>
                        	...
                        	<td>
                            	<a href="<?php echo site_url('/doctor/manage_language/edit_phrase/'.$field);?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_phrase');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo site_url('doctor/manage_language/delete_language/'.$field);?>"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(site_url('doctor/manage_language/add_phrase/') , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(site_url('doctor/manage_language/add_language/') , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
